...
public class EnemyAttack : MonoBehaviour
{
    ...
    IEnumerator FireProjectiles(GameObject target)
    {
        ...
        for (int i = 0; i < diceObjects.Length; i++)
        {
            ...
            BaseVfx vfx = bulletPrefab.GetComponent<BaseVfx>();
            if (vfx != null)
            {
                ...
                VfxData vd = new VfxData(origin, targetPos, travelTime, 1.0f);
            ...
            else
            {
                ...
                GameObject obj = Instantiate(bulletPrefab, midPoint, Quaternion.LookRotation(direction));
